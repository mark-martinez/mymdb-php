    ...
    <div class="col-auto mb-3">
        <div class="row justify-content-center">
            <div class="card-deck d-flex justify-content-center ">
                <div class="card p-2" style="border-width: 15px; border-color: #01d277; color:#01d277;">
                    <div class="card-body">
                ...
                <div class="card p-2"  style="border-width: 15px; border-color: #081c24; color:#081c24;">
                    <div class="card-body">
